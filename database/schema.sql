...
-- Insert default admin user (password: yatra@2024)
-- Password hash should be generated using bcrypt in application
INSERT INTO admin_users (name, email, password_hash, include_in_contributors, image_compression_quality) 
VALUES ('Admin', 'admin@yatra.com', '$2b$10$YourHashedPasswordHere', TRUE, 0.85)
